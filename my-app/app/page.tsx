            ...
            <div className="flex items-center gap-3">
              ...
              {navbarDropdownOpen && (
                <div className="absolute right-0 mt-2 w-56 bg-gray-900 rounded-lg shadow-2xl border border-gray-700 z-50">
                  ...
                  <Link
                    href="/login/guru"
                    className="block px-6 py-3 text-gray-300 hover:bg-emerald-50  hover:text-emerald-700  transition-colors duration-200"
                    onClick={() => setNavbarDropdownOpen(false)}
                  >
                    <div className="flex items-center gap-3">
                      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <Link
                    href="/login/admin"
                    className="block px-6 py-3 text-gray-300 hover:bg-green-50  hover:text-green-700  transition-colors duration-200"
                    onClick={() => setNavbarDropdownOpen(false)}
                  >
                    <div className="flex items-center gap-3">
                      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <Link
                    ...
                    className="block px-6 py-3 text-gray-300 hover:bg-purple-50  hover:text-purple-700  transition-colors duration-200 rounded-b-lg"
                    onClick={() => setNavbarDropdownOpen(false)}
                  >
                    <div className="flex items-center gap-3">
                      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
